...
export declare const CLIENT_INJECT: readonly ["slots", "locale", "connection", "layout", "sessions", "uiConversation", "workspaces", "remote", "remote.session"];
...
export declare function occupyDetails(slotsValue: unknown, face: () => object, panel: unknown, locale: string): void;
