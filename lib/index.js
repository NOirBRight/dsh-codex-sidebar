...
function apply(ctx, config = {}) {
	...
	const managedStream = new ManagedBrowserStream({
		...
		...browserConfig,
		...browserConfig?.desktopJpegMaxRawBytes === void 0 ? {} : { desktopMaxRawBytes: browserConfig.desktopJpegMaxRawBytes },
		...browserConfig?.mobileJpegMaxRawBytes === void 0 ? {} : { mobileMaxRawBytes: browserConfig.mobileJpegMaxRawBytes },
		...browserConfig?.browserCleanupTimeoutMs === void 0 ? {} : { shutdownTimeoutMs: browserConfig.browserCleanupTimeoutMs }
	});
