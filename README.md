...
```sh
dsh plugin --profile web add github:NOirBRight/dsh-codex-sidebar#v0.2.1
dsh web
```
...
```sh
DSH_HOME=~/.dsh-lab dsh plugin --profile web add github:NOirBRight/dsh-codex-sidebar#v0.2.1
```
