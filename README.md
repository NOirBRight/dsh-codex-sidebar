...
Version 0.5.4 starts the ICE negotiation clock only after the offer is sent, so Playwright page boot no longer burns the timeout. 0.5.3 added STUN sharing and host candidates in the offer.
