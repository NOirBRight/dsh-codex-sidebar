...
```sh
dsh plugin --profile web add github:NOirBRight/dsh-codex-sidebar#v0.3.4
dsh web
```
...
```sh
DSH_HOME=~/.dsh-lab dsh plugin --profile web add github:NOirBRight/dsh-codex-sidebar#v0.3.4
```
